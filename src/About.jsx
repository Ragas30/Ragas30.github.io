  ...
  return (
    <section id="about" className="min-h-screen bg-gradient-to-r from-blue-800 to-black grid grid-cols-1 md:grid-cols-2 gap-10 items-center p-10">
      ...
      <div className="text-left text-white space-y-6 transform translate-y-0 opacity-100 transition-all duration-1000" data-aos="fade-left" data-aos-anchor-placement="center-bottom" data-aos-offset="200" data-aos-duration="1000">
        <h1 className="text-4xl font-bold" data-aos="fade-up" data-aos-delay="100">
          Ragas Algaluh
        </h1>
        ...
        <p className="text-lg font-semibold text-blue-300" data-aos="fade-up" data-aos-delay="600">
