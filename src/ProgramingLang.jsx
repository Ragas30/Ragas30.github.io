...
export default function ProgramingLang() {
  return (
    <>
      <div id="skill" className="py-10 bg-gradient-to-r from-blue-800 to-black h-10">
        <div className=" z-50 mb-10 text-white">
          <Title title={"My Tech Stack"} />
        </div>
      </div>
      <section className="bg-gradient-to-r from-blue-800 to-black grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 items-center p-10">
        {data.map((item, index) => {
